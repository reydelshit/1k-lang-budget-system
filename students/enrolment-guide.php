                ...
                <div class="main_content">
                    ...
                    <div>
                        <div class="requirements">
                            <h1>Requirements</h1>
                            <h2>A. Original PSA Birth Certificate</h2>
                            <h2>B. Certificate of Good Moral Character</h2>
                            <h2>C. Original Copy of Report Card</h2>
                            <h2>D. Certificate of Completion</h2>
                            <h2>E. 6 PCS 2x2 Picture Green Background with Name Tag</h2>
                        </div>

                        <div class="steps">
                            <h1>STEPS</h1>
                            <div>
                                <h2> 1. REQUIREMENTS EVALUATION</h2>
                                <h3>Releasing of Medical Slip</h3>
                            </div>

                            <div>
                                <h2>2. MEDICAL EXAMINATION</h2>
                                <h3>Drug test</h3>
                            </div>

                            <div>

                                <h2>3. APPROVAL OF REGISTRATION</h2>
                                <h3>Present the unofficial form</h3>
                            </div>
                            <div>

                                <h2>4. VALIDATION OF ENROLLMENT</h2>
